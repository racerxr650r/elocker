...
baseline stands at 221 — *raised*, not lowered, because this change specified
the dead-code requirements HLR-137 to HLR-139 and they have no tests until
Phase 10 builds them. Phase 10 — dead code, reachability, and global state —
is ready to start.
