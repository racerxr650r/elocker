...
| 23 | <a id="HLR-011: five languages are detected from their extensions"></a>`HLR-011: five languages are detected from their extensions` | — | One target holding a file of each delivered language yields all five in the per-language breakdown. |
